...
export default class ProfileStore {
        ...
        try {
            ...
            runInAction(() => {
                if(this.profile && this.profile.photos){
                    this.profile.photos.find(c => c.isMain)!.isMain = false;
    ...
    setEditing = async (editing: boolean) => {
    ...
    loadUserActivities = async (username: string, predicate: string = 'future') => {
        this.loadingUserActivities = true;
        try {
            const userActivities = await agent.Profiles.activities(username, predicate);
            runInAction(() => {
